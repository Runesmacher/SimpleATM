package Runesmacher.register.payment;
...
public class Methods {
     ...
     */
    private void _init() {
        this.addMethod("iConomy", new Runesmacher.register.payment.methods.iCo6());
        this.addMethod("iConomy", new Runesmacher.register.payment.methods.iCo5());
        this.addMethod("iConomy", new Runesmacher.register.payment.methods.iCo4());
        this.addMethod("BOSEconomy", new Runesmacher.register.payment.methods.BOSE6());
        this.addMethod("BOSEconomy", new Runesmacher.register.payment.methods.BOSE7());
        this.addMethod("Essentials", new Runesmacher.register.payment.methods.EE17());
        this.addMethod("MultiCurrency", new Runesmacher.register.payment.methods.MCUR());
    }
